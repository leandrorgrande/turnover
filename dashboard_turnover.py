...
# =========================================================
# PAINEL DE QUALIDADE (RECOLHÍVEL)
# =========================================================
with st.expander("🧩 Análise de Qualidade e Estrutura dos Dados", expanded=False):
    st.markdown("Use esta seção para validar a estrutura antes de focar nos KPIs.")
    ...
    st.caption("Feche esta seção para focar nos indicadores abaixo.")
